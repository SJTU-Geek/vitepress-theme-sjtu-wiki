...
function genConfig() {
  ...
  const {
    ...
    enableFontSwitcher = true,
    enableSuggestionBox = true,
    suggestionBoxImageUrl,
    suggestionBoxLinkUrl,
  ...
  return defineConfigWithTheme<PjtsThemeConfig>({
    ...
    themeConfig: {
      ...
      fontsBaseUrl,
      // Shallow-merge user-supplied VitePress-native themeConfig fields.
      // Placed LAST so caller overrides win against theme defaults.
      ...extraThemeConfig,
    },
    locales, // i18n
